                    ...
                    Expanded(child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Expanded(child: Container(margin: EdgeInsets.only(left: 10, right: 10,top: 10),
                            decoration: BoxDecoration(
                                        ...
                                        Expanded(child: Row(
                                          children: [
                                            Expanded(child: Container(
                                              child: CircleAvatar(
                                                // backgroundColor: Colors.transparent,
                                                backgroundImage: AssetImage("assets/images/sonyliv.jpg"),
                                                radius: 35,
                                              )
                                            ),flex: 2,),
                                            Expanded(child: Container(
